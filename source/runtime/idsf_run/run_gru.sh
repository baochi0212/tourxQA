...
python predict.py  --idsf_data_dir $data --task phoATIS  --model_type gru --n_epochs 50 --train_batch_size 32 --eval_batch_size 1 --rnn_num_layers 3  --device cuda  --logging_steps 140 --module_role IDSF  --intent_loss_coef 0.6 --learning_rate 3e-5 --task phoATIS_plus --use_crf