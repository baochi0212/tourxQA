...
python trainer.py --idsf_data_dir $data --task phoATIS_plus  --model_type  lstm --n_epochs 50 --train_batch_size 32 --eval_batch_size 1 --rnn_num_layers 3  --device cuda    --logging_steps 140 --module_role IDSF  --intent_loss_coef 0.6 --learning_rate 5e-5 
python predict.py --idsf_data_dir $data --task phoATIS_plus  --model_type  lstm --n_epochs 50 --train_batch_size 32 --eval_batch_size 1 --rnn_num_layers 3  --device cuda    --logging_steps 140 --module_role IDSF  --intent_loss_coef 0.6 --learning_rate 5e-5 
...
python trainer.py --idsf_data_dir $data --use_crf --task phoATIS_plus    --model_type  lstm --n_epochs 50 --train_batch_size 32 --eval_batch_size 1 --rnn_num_layers 3  --device cuda    --logging_steps 140 --module_role IDSF  --intent_loss_coef 0.6 --learning_rate 5e-5 
python predict.py --idsf_data_dir $data --use_crf --task phoATIS_plus    --model_type  lstm --n_epochs 50 --train_batch_size 32 --eval_batch_size 1 --rnn_num_layers 3  --device cuda    --logging_steps 140 --module_role IDSF  --intent_loss_coef 0.6 --learning_rate 5e-5 
