...
class IntentPOSDataset(data.Dataset):
    ...
    - tokenizer:
    '''
    def __init__(self, data_dir, mode='train', level='word', MAX_LENGTH=100):
    ...
    def __getitem__(self, idx):
        ...
        return tokens['input_ids'].view(-1), intent_label, pos_label
    def __len__(self):
...
if __name__ == '__main__':
    ...
    # print("sample: ", dataset[0][0]['input_ids'], dataset[0][1], dataset[0][2])
