...
if __name__ == '__main__':
    ...
    parser.add_argument("--use_dev_training", action="store_true", help="Use for concat dev and train")
    ...
    #   if sample[3] not in train_label:
    #     train_label.append(sample[3].item())
    # for sample in test_dataset:
    #   if sample[3] not in test_label:
    #     test_label.append(sample[3].item())
    # print("train_label", train_label)
    # print("test_label", test_label)
    # for i in range(len(test_dataset)):
    #   if test_dataset[i][3].item() == 0:
    #     print(1)
