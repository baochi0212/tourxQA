...
class JointPhoBERT(RobertaPreTrainedModel):
    def __init__(self, config, args, intent_label_lst, slot_label_lst):
        ...
        self.intent_classifier = IntentAttentionClassifier(config.hidden_size, self.num_intent_labels, args.dropout_rate)

        self.slot_classifier = SlotAttentionClassifier(
            config.hidden_size,
