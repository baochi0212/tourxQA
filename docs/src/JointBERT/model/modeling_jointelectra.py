...
from transformers.models.roberta.modeling_roberta import ElectraModel, ElectraForPretraining

from .module import IntentClassifier, SlotClassifier


class JointPhoBERT(ElectraForPretraining):
    def __init__(self, config, args, intent_label_lst, slot_label_lst):
        super(JointPhoBERT, self).__init__(config)
        self.args = args
        self.num_intent_labels = len(intent_label_lst)
        self.num_slot_labels = len(slot_label_lst)
        self.roberta = ElectraModel(config)  # Load pretrained phobert
