...
parser.add_argument('--bert_init', type=str, default='roberta-base',
                    choices=['roberta-base', 'roberta-large', 'bert-base-uncased', 'bert-large-uncased', 'vinai/phobert-base'])
parser.add_argument('--pretrained_bert_ckpt', default=None)
parser.add_argument('--dataset', default='R8', choices=['20ng', 'R8', 'R52', 'ohsumed', 'mr', 'phoatis'])
...
print("AFTER: ", input_ids[-nb_test-nb_word:-nb_test]) #check the added word tokenizer (prior to the test cuz the features construting process)
